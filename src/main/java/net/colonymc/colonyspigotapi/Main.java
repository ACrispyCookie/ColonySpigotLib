...
import net.colonymc.colonyspigotapi.commands.images.ParticleImgCommand;
import net.colonymc.colonyspigotapi.commands.images.ReloadImagesCommand;
import net.colonymc.colonyspigotapi.commands.items.EnchantCommand;
import net.colonymc.colonyspigotapi.commands.items.GiveCommand;
import net.colonymc.colonyspigotapi.commands.items.LoreCommand;
import net.colonymc.colonyspigotapi.commands.items.RenameCommand;
import net.colonymc.colonyspigotapi.commands.player.FlyCommand;
import net.colonymc.colonyspigotapi.commands.player.GamemodeCommand;
import net.colonymc.colonyspigotapi.commands.player.HealCommand;
import net.colonymc.colonyspigotapi.commands.player.SpeedCommand;
import net.colonymc.colonyspigotapi.commands.warp.RemoveWarpCommand;
import net.colonymc.colonyspigotapi.commands.warp.SetWarpCommand;
import net.colonymc.colonyspigotapi.commands.warp.WarpCommand;
